...
def write_tensorboard(
    ...
    writer.add_scalar("val/train_loss", train_loss, epoch)
    writer.add_scalar("val/train_accuracy", train_accuracy, epoch)
    writer.add_scalar("val/train_precision", train_precision, epoch)
    writer.add_scalar("val/train_recall", train_recall, epoch)
    
    writer.add_scalar("val/valid_loss", valid_loss, epoch)
    writer.add_scalar("val/valid_accuracy", valid_accuracy, epoch)
    writer.add_scalar("val/valid_precision", valid_precision, epoch)
    writer.add_scalar("val/valid_recall", valid_recall, epoch)
